...
This project can be containerized in Docker. Open Docker Desktop and run ***docker build -t sunsoutbunsout .*** to build a local docker image. Run ***docker run -p 8080:80 sunsoutbunsout*** to run the docker container.